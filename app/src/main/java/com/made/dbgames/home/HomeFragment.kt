...
import com.made.dbgames.databinding.FragmentHomeBinding
                ...
                if (gameList != null) {
                    when (gameList) {
                        ...
                        is Resource.Success -> {
                            ...
                            gameAdapter.setData(gameList.data)
                        }
                        is Resource.Error -> {
                            binding.progressBar.visibility = View.GONE
                            binding.viewError.root.visibility = View.VISIBLE
                            binding.viewError.tvError.text = gameList.message ?: getString(R.string.something_wrong)
                        }
                    }
                }
            })
