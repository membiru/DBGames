package com.made.dbgames.core.di

import androidx.room.Room
import com.made.dbgames.core.data.GameRepository
import com.made.dbgames.core.data.source.local.LocalDataSource
import com.made.dbgames.core.data.source.local.room.GameDatabase
...
val databaseModule = module {
    ...
    single {
        val passphrase: ByteArray = SQLiteDatabase.getBytes("dbgames".toCharArray())
        val factory = SupportFactory(passphrase)

        Room.databaseBuilder(
            androidContext(),
            GameDatabase::class.java, "DBGames.db"
